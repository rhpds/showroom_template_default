...
. Leave the default values and click on Submit. This sets up the VAN routers in the namespace.The *Enable link access* is checked indicating that this site will allow ingress connections from other sites.
+
