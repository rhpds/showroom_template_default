...
. Access the Web App by clicking https://travels-blue-ui-travels-web.apps.{ocp_cluster_openshift_cluster_ingress_domain}/[here^, console="access Web app"]
...
. Refresh the Web application or access it from https://travels-blue-ui-travels-web.apps.{ocp_cluster_openshift_cluster_ingress_domain}/[here^, console="access Web app"]. You should see a *403 - Forbidden* error
+
image:m3/partner-blue-403.png[] 
